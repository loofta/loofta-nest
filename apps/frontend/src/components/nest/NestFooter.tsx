...
export function NestFooter({ dark, onToggleDark }: { dark: boolean; onToggleDark: () => void }) {
  return (
    <footer style={{ borderTop: "1px solid var(--line2)", marginTop: 56, padding: "32px 64px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
